...
public class TestRepository {
	...
	//public void testFindByEmail(){
		//Customer customer = new Customer("chencho Placencio", "tomabien@gmail.com");
	//entityManager.persist(customer);
	
	//Customer custFound = customerRepository.findByEmail("tomabien@gmail.com");
	//assertThat(custFound.getName()).isEqualTo(customer.getName());
	//assertThat(custFound.getEmail()).isEqualTo(customer.getEmail());
	//}
